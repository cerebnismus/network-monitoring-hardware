...
didsoft_credentials = "oguzhan.ince@protonmail.com:p5ckpb"
didsoft_proxy = "46.4.73.88:2000"

PROXY_HOST = '46.4.73.88'  # rotating proxy or host
PROXY_PORT = 2000 # port
PROXY_USER = 'oguzhan.ince@protonmail.com' # username
PROXY_PASS = 'p5ckpb' # password


# paid partners
# https://anti-captcha.com/
# https://my.didsoft.com
...
def main():
    ...
    driver.find_element(By.XPATH, '//*[@class="mat-focus-indicator btn mat-btn-lg btn-brand-orange d-none d-lg-inline-block position-absolute top-n3 right-0 z-index-999 mat-raised-button mat-button-base"]').click()
    ...
    for sound in range(60):  # play sound to notify the end of the process for loop
